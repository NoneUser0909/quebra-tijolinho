...
function draw() {
  ...
  strokeWeight(2);
  fill("black");  
  text("por: Void", width - 80, height - 20);
  ...
  if (gameInfo && !gameStarted && !gameOver && !gameWon) {
    ...
    strokeWeight(3);
    stroke(0);
    text("use as setas do teclado para mover a raquete", width / 2, height / 2);
    text("use 1 e 2 para alternar o leveis!", width / 2, height / 2 + 25);
    fill("Khaki");
